...
class CoreSerializer(ModelSerializer):
    class Meta:
        model = Core
        fields = ['coins', 'click_power', 'auto_click_power', 'next_level_price', 'damage', 'hp', 'level', 'level_enemy'] # Добавляем поле next_level_price, которое нужно вернуть на фронт.
    ...
    def get_hp(self, obj):
        return obj.calculate_next_hp_enemy()
